...
class pregradosunach extends StatelessWidget {
  pregradosunach({Key? key}) : super(key: key);

  final List<NewsCa> news = [
    NewsCa(
        title: 'Lincenciatura en Estadística y Sistemas de Información',
        imageUrl: 'assets/esi.jpg',
        page: ejemplo()),
    NewsCa(
        title: 'Lincenciatura en Desarrollo municipal y gobernabilidad',
        imageUrl: 'assets/dgm.jpg',
        page: ejemplo()),
    NewsCa(
        title: 'Lincenciatura en Gerencia Social',
        imageUrl: 'assets/gerencia.jpg',
        page: ejemplo()),
  ];
